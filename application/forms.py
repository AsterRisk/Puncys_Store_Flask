...
from wtforms import StringField, PasswordField, DateField, TimeField, SubmitField, BooleanField, SelectField, Field
...
class OrderForm(FlaskForm):
        ...
        #user_measurements = query("select * from measurements where user_id = {};".format(user_id))
    ...
    # || User Data
        ...
        due_date   = StringField(id="datepicker", validators = [], render_kw={}, _name="due_date")
        ...
        # || Miscellaneous
        meas_name     = StringField(_name = 'meas_name', validators = [], render_kw={})
        meas_select   = SelectField('meas_select', validators = [], render_kw={})
